...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  MPU6500_Read(&MPU6500_Raw);
	  		...
	  		sprintf(bufferTxt," ax= %0.2f ",MPU6500_Conv.MPU6500_floatAX);
	  		HAL_UART_Transmit(&huart1, (uint8_t *)bufferTxt, strlen(bufferTxt), HAL_MAX_DELAY);
	  		sprintf(bufferTxt," ay= %0.2f ",MPU6500_Conv.MPU6500_floatAY);
	  		HAL_UART_Transmit(&huart1, (uint8_t *)bufferTxt, strlen(bufferTxt), HAL_MAX_DELAY);
	  		sprintf(bufferTxt," az= %0.2f \r\n",MPU6500_Conv.MPU6500_floatAZ);
	  		HAL_UART_Transmit(&huart1, (uint8_t *)bufferTxt, strlen(bufferTxt), HAL_MAX_DELAY);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_OK_Pin|LED_ALARMA_Pin|LED_AVISO_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SPI_NSS_GPIO_Port, SPI_NSS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED_OK_Pin LED_ALARMA_Pin LED_AVISO_Pin */
  GPIO_InitStruct.Pin = LED_OK_Pin|LED_ALARMA_Pin|LED_AVISO_Pin;
